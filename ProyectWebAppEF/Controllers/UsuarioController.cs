...
using ProyectWebAppEF.AppServices;
...
namespace ProyectWebAppEF.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuario>> PostUsuario(Usuario item)
        {
            ...
            if(respuesta == null)
            {
                return CreatedAtAction(nameof(GetUsuario), new { Id = item.Idusuario }, item);
            }
            return null;
        }
        ...
        {
            IEnumerable<Usuario> usuarios = _baseDatos.Usuarios.Where(q => ids.Contains(q.Idusuario));
